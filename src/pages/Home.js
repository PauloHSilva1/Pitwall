      ...
      {projectData ? (
        ...
        <div>
          ...
          <div style={{ textAlign: 'left', padding: '1vh' }}>
            <Typography variant='h6'>Projeto: {projectData.name}</Typography>
            <Typography variant='subtitle'>Descrição: {projectData.description}</Typography>
          </div>
            
          </div>
          
            <div style={{display:'flex',flexDirection:'row', paddingLeft:'1vw',justifyContent:'right',alignItems:'center'}}>
